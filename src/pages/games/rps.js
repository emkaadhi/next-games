...
import { add_game } from '../../store/games'
...
const RPS = () => {
  ...
  const addGameData = useSelector((state) => state.games.addGameData)
  ...
  const handleSaveClick = async () => {
    ...
    dispatch(add_game({playerId,score,counter,userLoss,userDraw,userWin,name,avatar}))
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-2 col-sm-6 col-12 mt-3">
              <div className="info-box">
                <span className="info-box-icon bg-success"><i className="fas fa-thumbs-up text-white" /></span>
            ...
            <div className="col-md-2 col-sm-6 col-12 mt-3">
              <div className="info-box">
                <span className="info-box-icon bg-info"><i className="fas fa-handshake text-white" /></span>
                <div className="info-box-content">
            ...
            <div className="col-md-2 col-sm-6 col-12 mt-3">
              <div className="info-box">
                <span className="info-box-icon bg-danger"><i className="fas fa-thumbs-down text-white" /></span>
                <div className="info-box-content">
            ...
            <div className="col-md-2 col-sm-6 col-12 mt-3">
              <div className="info-box">
                <span className="info-box-icon bg-warning"><i className="fas fa-chalkboard-teacher text-white"></i></span>
                <div className="info-box-content">
            ...
            <div className="col-md-3 col-sm-6 col-12 mt-3">
              <div className="info-box">
                <span className="img-rounded"><img src={avatar} className="avatar avatar-lg rounded-circle" /></span>
                <div className="info-box-content">
          ...
          <div className="row my-3">
            <div className="col-md-4">
              <h3 className='text-uppercase text-center text-white'>Player <span className='text-danger'>choice</span> <span className='text-white'>({counter})</span> </h3>
            ...
            <div className="col-md-4">
              <h3 className='text-uppercase text-center text-white'>computer <span className='text-danger'>choice</span></h3>
              <div className="mt-4 text-center">
                {
                  computerChoice === 'rock' && (
                    <img src='/rock.svg' alt="" style={{ width: '150px' }} />
            ...
            {choices.map((choice, index) => <button key={index} className='btn bg-gradient-primary btn-sm mb-3 mt-3 ml-3' onClick={() => handleClick(choice)}>{choice}</button>)}
          <div className="justify-content-center">
            <button className='btn btn-danger' type='submit' onClick={handleSaveClick}>quit and save</button>
          </div>
        </div>
      </section>
    </>
